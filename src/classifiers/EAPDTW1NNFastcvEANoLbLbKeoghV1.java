 ...
 */
public class EAPDTW1NNFastcvEANoLbLbKeoghV1 extends EAPDTW1NNLbKeogh {
    public EAPDTW1NNFastcvEANoLbLbKeoghV1() {
        super();
        this.classifierIdentifier = "EAPDTW_1NN-FastCV_EA_NoLB-LbKeoghV1";
    }

    public EAPDTW1NNFastcvEANoLbLbKeoghV1(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "EAPDTW_1NN-FastCV_EA_NoLB-LbKeoghV1";
    }

    public EAPDTW1NNFastcvEANoLbLbKeoghV1(final int paramId, final Sequences trainData) {
