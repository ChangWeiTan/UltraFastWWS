 ...
 */
public class UltraFastERP extends EAPERP1NN {
    final int ubParam = 0;

    public UltraFastERP() {
        super();
        this.classifierIdentifier = "UltraFastERP";
    }

    public UltraFastERP(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastERP";
    }

    public UltraFastERP(final int paramId, final Sequences trainData) {
