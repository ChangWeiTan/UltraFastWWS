 ...
 */
public class UltraFastMSM6 extends EAPMSM1NN {
    public UltraFastMSM6() {
        super();
        this.classifierIdentifier = "UltraFastMSM5";
    }

    public UltraFastMSM6(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastMSM5";
    }

    public UltraFastMSM6(final int paramId, final Sequences trainData) {
