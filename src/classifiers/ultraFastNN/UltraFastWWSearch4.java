 ...
 */
public class UltraFastWWSearch4 extends EAPDTW1NNLbKeogh {
    final int ubParam = 0;

    public UltraFastWWSearch4() {
        super();
        this.classifierIdentifier = "UltraFastWWSearch";
    }

    public UltraFastWWSearch4(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastWWSearch";
    }

    public UltraFastWWSearch4(final int paramId, final Sequences trainData) {
