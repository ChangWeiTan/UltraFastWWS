 ...
 */
public class UltraFastTWE6 extends EAPTWE1NN {
    final int ubParam = nParams - 1;

    public UltraFastTWE6() {
        super();
        this.classifierIdentifier = "UltraFastTWE6";
    }

    public UltraFastTWE6(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastTWE6";
    }

    public UltraFastTWE6(final int paramId, final Sequences trainData) {
