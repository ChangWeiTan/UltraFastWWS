 ...
 */
public class UltraFastMSM3 extends EAPMSM1NN {
    final int ubParam = nParams - 1;

    public UltraFastMSM3() {
        super();
        this.classifierIdentifier = "UltraFastMSM3";
    }

    public UltraFastMSM3(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastMSM3";
    }

    public UltraFastMSM3(final int paramId, final Sequences trainData) {
