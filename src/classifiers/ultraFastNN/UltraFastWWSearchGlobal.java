 ...
 */
public class UltraFastWWSearchGlobal extends EAPDTW1NNLbKeogh {
    final int ubParam = 0;

    public UltraFastWWSearchGlobal() {
        super();
        this.classifierIdentifier = "UltraFastWWSearch3";
    }

    public UltraFastWWSearchGlobal(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastWWSearch3";
    }

    public UltraFastWWSearchGlobal(final int paramId, final Sequences trainData) {
