 ...
 */
public class UltraFastTWE extends EAPTWE1NN {
    final int ubParam = nParams - 1;

    public UltraFastTWE() {
        super();
        this.classifierIdentifier = "UltraFastTWE";
    }

    public UltraFastTWE(final Sequences trainData) {
        super(trainData);
        this.classifierIdentifier = "UltraFastTWE";
    }

    public UltraFastTWE(final int paramId, final Sequences trainData) {
