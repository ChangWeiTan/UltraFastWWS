            ...
            for (int paramId = nParams - 1; paramId > -1; --paramId) {
                ...
                if (currPNN.isNN()) {
                    ...
                    for (int previous = 0; previous < current; ++previous) {
                        ...
                        final LazyAssessNNEAPDTW.RefineReturnType rrt = challenger.tryToBeat(toBeat, win, toBeat);
                    ...
                    for (LazyAssessNNEAPDTW challenger : challengers) {
                        ...
                        LazyAssessNNEAPDTW.RefineReturnType rrt = challenger.tryToBeat(toBeat, win, toBeat);
