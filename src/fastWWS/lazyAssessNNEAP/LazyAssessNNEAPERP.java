 ...
 */
public class LazyAssessNNEAPERP extends LazyAssessNN {
    private final EAPERP distComputer = new EAPERP();
    private double currentG;
    private double currentBandSize;
    private int currentWindowSize;

    public LazyAssessNNEAPERP(final SequenceStatsCache cache) {
        super(cache);
    }

    public LazyAssessNNEAPERP(final Sequence query, final int index,
    ...
    private void setCurrentGandBandSize(final double g, final double bandSize) {
        if (this.currentG != g) {
            currentWindowSize = getWindowSize(query.length(), bandSize);
