...
public class ScalabilitySizeTask implements Callable<Integer> {
    String[] datasets;
    double[] subsetSizes;
    int threadCount;

    public ScalabilitySizeTask(String[] datasets, int threadCount) {
        this.datasets = datasets;
        this.threadCount = threadCount;
    }


    public ScalabilitySizeTask(String[] datasets, int threadCount, double[] subsetSize) {
        this.datasets = datasets;
        this.threadCount = threadCount;
    ...
    private void singleRun(String problem, double ratio) throws Exception {
        ...
        if (Application.verbose > 1) {
            ...
            println("[Thread_" + threadCount + "] Number of instances: " + trainData.size());
        }
